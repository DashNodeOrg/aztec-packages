...
void PrecomputedTraceBuilder::process_public_inputs_aux(TraceContainer& trace)
{
    using C = Column;
...
void PrecomputedTraceBuilder::process_public_inputs(TraceContainer& trace, const PublicInputs& public_inputs)
{
    using C = Column;
